...
struct MPCDemo:
    ...
    fn _test_mpc_controller():
        ...
        success_rate = (
            Float64(successful_optimizations) / Float64(mpc_cycles) * 100.0
        )
    ...
    fn _simulate_system_response(
        ...
        var new_pend_vel = (
            pend_vel + (gravity_effect + control_effect - damping) * dt
        )
