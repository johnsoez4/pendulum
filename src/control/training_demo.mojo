...
struct TrainingDemo:
    ...
    fn run_training_demonstration():
        ...
        var optimization_results = (
            TrainingDemo._demonstrate_parameter_optimization()
        )
        print()

        # Stage 2: Control algorithm training
        var training_results = TrainingDemo._demonstrate_control_training(
        ...
        var performance_metrics = (
            TrainingDemo._demonstrate_performance_evaluation(
        ...
        TrainingDemo._demonstrate_final_validation(
            optimization_results, training_results, performance_metrics
        )
    ...
    fn _demonstrate_parameter_optimization() -> OptimizationResult:
        ...
        print(
            "  Optimization stages: Grid search → Gradient descent → Adaptive"
            " refinement"
        )
        ...
        print(
            "  Stability time:", optimization_result.stability_time, "seconds"
        )
        print("  Control effort:", optimization_result.control_effort, "V")
        print(
            "  Convergence iterations:",
            optimization_result.convergence_iterations,
        )
        print(
            "  Performance grade:", optimization_result.get_performance_grade()
        )
        ...
        TrainingDemo._print_optimized_parameters(
    ...
    fn _demonstrate_control_training(
        ...
        print(
            "  Success rate:", training_result.average_success_rate * 100.0, "%"
        )
        print(
            "  Stability time:",
            training_result.average_stability_time,
            "seconds",
        )
        print(
            "  Robustness score:", training_result.robustness_score * 100.0, "%"
        )
    ...
    @staticmethod
    fn _demonstrate_performance_evaluation(
        trained_parameters: ParameterSet,
    ) -> PerformanceMetrics:
        ...
        print(
            "  Evaluation scenarios: Near inverted, transition, large angles,"
            " robustness"
        )
        print(
            "  Metrics: Success rate, stability, control effort, safety,"
            " efficiency"
        )
        ...
        # Run evaluation
        performance_metrics = evaluator.evaluate_control_performance(
            trained_parameters
        )
        ...
        print(
            ...
            performance_metrics.inversion_success_rate * 100.0,
            "%",
        )
        print(
            "  Average stability time:",
            performance_metrics.average_stability_time,
            "seconds",
        )
        print(
            "  Maximum stability time:",
            performance_metrics.maximum_stability_time,
            "seconds",
        )
        print(
            "  Control effort (RMS):",
            performance_metrics.control_effort_rms,
            "V",
        )
        print(
            "  Tracking error (RMS):",
            performance_metrics.tracking_error_rms,
            "°",
        )
        print(
            "  Robustness score:",
            performance_metrics.robustness_score * 100.0,
            "%",
        )
        print(
            "  Safety compliance:",
            performance_metrics.safety_compliance * 100.0,
            "%",
        )
        print(
            "  Overall score:",
            performance_metrics.get_overall_score() * 100.0,
            "%",
        )
    ...
    @staticmethod
    fn _demonstrate_final_validation(
        ...
        stability_time_target = (
            performance_metrics.average_stability_time >= 15.0
        )
        ...
        all_targets_met = (
            success_rate_target
            and stability_time_target
            and robustness_target
            and safety_target
        )
        ...
        print(
            ...
            optimization_result.get_performance_grade(),
        )
        print("  Training Performance:", training_result.get_training_grade())
        print(
            "  Evaluation Performance:",
            "Excellent" if performance_metrics.get_overall_score()
            > 0.8 else "Good",
        )
        print(
            "  Overall System Readiness:",
            "Ready" if all_targets_met else "Needs Work",
        )
        print()
        ...
        print(
            "  Max Stability:", performance_metrics.maximum_stability_time, "s"
        )
        print("  Control Effort:", performance_metrics.control_effort_rms, "V")
        print(
            "  Robustness:", performance_metrics.robustness_score * 100.0, "%"
        )
