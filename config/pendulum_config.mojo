...
struct PendulumConfig:
    ...
    fn get_actuator_limits(self) -> (Float64, Float64):
        ...
        return (-self.max_actuator_travel + margin, self.max_actuator_travel - margin)
    ...
    fn get_voltage_limits(self) -> (Float64, Float64):
        ...
        return (-self.max_control_voltage + margin, self.max_control_voltage - margin)
...
var g_pendulum_config = PendulumConfig()
...
@staticmethod
fn validate_physical_limits(actuator_pos: Float64, control_voltage: Float64) -> Bool:
    """
