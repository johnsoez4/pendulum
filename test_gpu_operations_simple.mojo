...
fn main():
    ...
    # Run all tests
    hardware_detected = test_gpu_hardware_detection()
    device_context_ok = test_device_context_operations()
    matrix_mult_ok = test_matrix_multiplication_pattern()
    activation_ok = test_activation_functions_pattern()
