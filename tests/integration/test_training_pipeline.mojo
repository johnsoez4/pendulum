...
struct TrainingPipelineTests:
    ...
    @staticmethod
    fn test_data_generation() raises:
    ...
    @staticmethod
    fn test_validation_pipeline() raises:
        ...
        _ = val_loss  # network.validation_loss
    ...
    @staticmethod
    fn test_physics_constraint_enforcement() raises:
