...
fn test_individual_benchmarks():
    ...
    print(
        "Matrix benchmark completed - Speedup:",
        matrix_result.speedup_factor,
        "x",
    )
    ...
    print(
        "Neural network benchmark completed - Speedup:",
        nn_result.speedup_factor,
        "x",
    )
    ...
    print(
        "Control optimization benchmark completed - Speedup:",
        control_result.speedup_factor,
        "x",
    )
